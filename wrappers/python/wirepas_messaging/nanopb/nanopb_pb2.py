...
# source: wirepas_messaging/nanopb/nanopb.proto
...
NanoPBOptions = _reflection.GeneratedProtocolMessageType('NanoPBOptions', (_message.Message,), dict(
  ...
  __module__ = 'wirepas_messaging.nanopb.nanopb_pb2'
