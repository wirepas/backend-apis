...
class FloorPlanExample(object):
    ...
    def __init__(self) -> None:
        ...
        self.logger = wnt.utils.setup_log(
            'FloorPlanExample', self.settings.log_level)
    ...
    def send_request(self) -> None:
        ...
        if self.state == self.State.LOGIN:
            ...
            self.metadata_thread.socket.send(
                json.dumps(self.messages.message_get_image(self.floor_plan_image_thumbnail_id)))
    ...
    def parse_response(self, message: str) -> bool:
        ...
        if self.state == self.State.LOGIN:
            ...
            if parse_result:
                FileHelper.write_file_content_from_base64(self.temp_floor_plan_image_file_path,
            ...
            if parse_result:
                FileHelper.write_file_content_from_base64(self.temp_floor_plan_image_thumbnail_file_path,
                                                          self.messages.image_data_base64)
            return parse_result
