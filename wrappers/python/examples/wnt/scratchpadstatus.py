...
from wirepas_messaging.wnt.ws_api import RealtimeSituationMessages, ScratchpadStatusMessages
...
class ComponentsInformationExample(object):
    ...
    def __init__(self) -> None:
        ...
        self.logger = wnt.utils.setup_log(
            'ScratchpadStatusExample', self.settings.log_level)
    ...
    def realtime_situation_on_message(self, _websocket, message: str) -> None:
        ...
        if wnt_message.HasField('scratchpad_status'):
            self.logger.info(
                'scratchpad_status:\nnetwork id: {}\nnode id: {}\n{}'.format(
                    wnt_message.network_id, wnt_message.source_address,
