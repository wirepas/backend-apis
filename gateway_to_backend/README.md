...
The backend to gateway API is based on a set of MQTT topics where messages are encoded encoded as [Protocol Buffers (syntax 2)][https://developers.google.com/protocol-buffers]. All the messages in the MQTT topics have the same 
...
>
> **content:** [StatusEvent message format][message_StatusEvent]
...
>
> **content:** [GetConfigsReq message format][message_GetConfigsReq]

**Response:**

> **topics:** gw-response/get_configs/*\<gw-id\>*
>
> **content:** [GetConfigsResp message format][message_GetConfigsResp]
>              and [SinkReadConfig message format][message_SinkReadConfig]
...
>
> **content:** [SetConfigReq  message format][message_SetConfigReq] and [SinkNewConfig message format][message_SinkNewConfig]

**Response:**

> **topics:** gw-response/set_config/*\<gw-id\>/\<sink-id\>*
>
> **content:** [SetConfigResp message format][message_SetConfigResp]
...
>
> **content:** [GetGwInfoReq message format][message_GetGwInfoReq]

**Response:**

> **topics:** gw-response/set_config/*\<gw-id\>/\<sink-id\>*
>
> **content:** [GetGwInfoResp message format][message_GetGwInfoResp] and [GatewayInfo message format][message_GatewayInfo]
...
>
> **content:** [SendPacketReq message format][message_SendPacketReq]

**Response:**

> **topics:** gw-response/send_data/*\<gw-id\>/\<sink-id\>*
>
> **content:** [SendPacketResp message format][message_SendPacketResp]

#### Packet received event

> **topic:** gw-event/received_data/*\<gw-id\>/\<sink-id\>/\<net_id\>/\<src_ep\>/\<dst_ep\>*
>
> **content:** [PacketReceivedEvent message format][message_PacketReceivedEvent]
...
>
> **content:** [GetScratchpadStatusReq message format][message_GetScratchpadStatusReq]

**Response:**

> **topics:** gw-response/otap_status/*\<gw-id\>/\<sink-id\>*
>
> **content:** [GetScratchpadStatusRes message format][message_GetScratchpadStatusRes]
...
>
> **content:** [UploadScratchpadReq message format][message_UploadScratchpadReq]

**Response:**

> **topics:** gw-response/otap_status/*\<gw-id\>/\<sink-id\>*
>
> **content:** [UploadScratchpadResp message format][message_UploadScratchpadResp]
...
>
> **content:** [ProcessScratchpadReq message format][message_ProcessScratchpadReq]

**Response:**

> **topics:** gw-response/otap_status/*\<gw-id\>/\<sink-id\>*
>
> **content:** [ProcessScratchpadResp message format][message_ProcessScratchpadResp]
...
```mqtt
    ...
    gw-event/received_data/<gw-id>/<sink-id>/<net\_id>/<src\_ep>/<dst\_ep>
```
